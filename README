...
- Game design (GDD) — description des ennemis, du joueur, des mécaniques et globalement du jeu : [Game design document](<URL_VERS_GDD>)  
- Diagramme de classes : [diagramme de classes](<Diagramme épurée.svg>)
